...
const AudioWorkspace: React.FC = () => {
    ...
    return (
        <div className="w-full flex grow min-h-screen text-gray-200 relative overflow-hidden">
            <FontAwesomeIcon className="flex justify-center items-center w-4 h-4 p-2 bg-tertiary rounded-full absolute left-3 top-3 z-50" onClick={handlePlayPauseAll}
            ...
            <div className="w-full min-h-screen text-gray-200 overflow-x-auto" onDrop={handleDrop} onDragOver={handleDragOver}>
                ...
                {/* Correctly pass props to AudioWaveform */}
                <AudioWaveform
                ...
                <button className="w-full p-2" onClick={openFileDialog}>
                    <div className="border-2 border-dashed border-secondary p-4 rounded-lg h-20 flex items-start w-full">
                        <p className="text-nowrap text-white text-opacity-50 text-xs">
