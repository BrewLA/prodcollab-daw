...
//                 <button className="w-6 h-6 rotate-90 rounded-lg border border-secondary flex-col justify-center items-center inline-flex">
...
const AudioImport = () => {
  ...
  return (
    <div className={`h-full p-4 bg-secondary border-r border-secondary flex flex-col justify-start items-start gap-4 overflow-x-hidden transition-all duration-300 ${isOpened ? 'w-64' : 'w-16'}`}>
      <div className="justify-between items-center flex w-full">
        <h2 className={`text-xs text-white font-medium text-nowrap ${isOpened ? '' : 'hidden'}`}>Imported Audio</h2>
        <button className="w-6 h-6 rounded-lg border border-secondary flex-col justify-center items-center inline-flex text-white" onClick={toggleCollapse}>
          <FontAwesomeIcon className="p-2" icon={isOpened ? faChevronLeft : faChevronRight} />
        </button>
      </div>
      <Collapse isOpened={isOpened}>
        <div className="flex-col justify-start items-start gap-2 flex">
          <div className="p-2 bg-tertiary rounded-lg flex-col justify-start items-start gap-2 flex w-full">
              <div className="opacity-50 text-white text-opacity-50 text-xs font-medium">Drum Pack</div>
            <div className="border-l border-white border-opacity-15 justify-start items-start gap-2.5 inline-flex">
              <div className="py-2 px-3.5 flex flex-col justify-start items-start gap-4 text-xs text-white font-medium">
                <h3>Kick_01.wav</h3>
                <h3>Kick_02.wav</h3>
                <h3>Kick_03.wav</h3>
                <h3>HiHat_01.wav</h3>
